...
export function UserProfileModal() {
  ...
  const [selectedFavorites, setSelectedFavorites] = useState<ActiveModuleId[]>(
    user.favorites || [],
  );
  ...
  return (
    <Modal
      ...
      description="Manage personal details, theme, and shortcuts"
      icon={<User className="w-4 h-4" />}
      topAccentColor="#0052FF"
      maxWidth="xl"
    >
      {/* Tab Navigation */}
      <div className="flex items-center gap-1.5 pt-1 pb-2 border-b border-border/60">
        {[
      ...
      <form
        onSubmit={handleSave}
        className="pt-4 overflow-y-auto space-y-4 max-h-[65vh] px-1.5 py-1"
      >
        ...
        {activeTab === "favorites" && (
          <div className="space-y-3">
            <div className="p-3 rounded-2xl bg-[#0052FF]/10 border border-[#0052FF]/20 text-[#0052FF] text-xs flex items-center gap-2">
              ...
              <span>
                Pinned favorite modules appear at the top of your sidebar for
                quick access.
              </span>
            </div>
              ...
              {pages.map((m) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Star
                        className={`w-3.5 h-3.5 ${isChecked ? "text-[#0052FF] fill-[#0052FF]" : "text-muted-foreground"}`}
                      />
