...
export function LandingTasks({ onOpenAuth }: { onOpenAuth: (mode: 'login' | 'signup') => void }) {
  return (
    <section id="tasks" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 relative border-t border-slate-200/60">
      ...
      <div className="absolute top-12 left-10 w-16 h-16 opacity-25 pointer-events-none -z-0 hidden md:block select-none">
        <Image src={clockIcon} alt="Clock" width={64} height={64} draggable={false} className="object-contain no-drag select-none pointer-events-none" />
      </div>
      <div className="absolute bottom-10 right-12 w-14 h-14 opacity-25 pointer-events-none -z-0 hidden md:block select-none">
        <Image src={timerIcon} alt="Timer" width={56} height={56} draggable={false} className="object-contain no-drag select-none pointer-events-none" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
        ...
        <div className="lg:col-span-6 order-2 lg:order-1 relative flex justify-center select-none">
          <div className="absolute -top-4 -right-4 w-12 h-12 opacity-25 pointer-events-none z-20 hidden sm:block">
            <Image src={calendarIcon} alt="Calendar" width={48} height={48} draggable={false} className="object-contain no-drag select-none pointer-events-none" />
          </div>
        ...
        <div className="lg:col-span-6 order-1 lg:order-2 space-y-6">
          ...
          <p className="text-base text-slate-600 leading-relaxed font-medium">
            Prioritize with Eisenhower matrix (P1 to P4), break down goals into subtasks, and track due times effortlessly. Say goodbye to scattered to-do lists.
          </p>
          ...
          <div className="grid grid-cols-3 gap-3 pt-2">
            <div className="p-3.5 rounded-2xl bg-white border border-slate-200/80 shadow-2xs">
              ...
              <div className="text-[11px] font-bold text-slate-500">Less Procrastination</div>
            </div>
            <div className="p-3.5 rounded-2xl bg-white border border-slate-200/80 shadow-2xs">
              <div className="text-2xl font-extrabold text-[#0052FF]">4.8x</div>
              <div className="text-[11px] font-bold text-slate-500">Execution Velocity</div>
            </div>
            <div className="p-3.5 rounded-2xl bg-white border border-slate-200/80 shadow-2xs">
              <div className="text-2xl font-extrabold text-[#10B981]">100%</div>
              <div className="text-[11px] font-bold text-slate-500">Cloud Sync</div>
            </div>
          </div>
